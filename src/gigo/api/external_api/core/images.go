...
func SiteImages(ctx context.Context, callingUser *models.User, tidb *ti.Database, id int64, username string, post bool, storageEngine storage.Storage) (io.ReadCloser, error) {
