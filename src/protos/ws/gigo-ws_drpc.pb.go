...
type DRPCGigoWSClient interface {
	...
	GetResourceUtil(ctx context.Context, in *GetResourceUtilRequest) (*GetResourceUtilResponse, error)
}
...
func (c *drpcGigoWSClient) GetResourceUtil(ctx context.Context, in *GetResourceUtilRequest) (*GetResourceUtilResponse, error) {
	out := new(GetResourceUtilResponse)
	err := c.cc.Invoke(ctx, "/ws.GigoWS/GetResourceUtil", drpcEncoding_File_gigo_ws_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DRPCGigoWSServer interface {
	...
	GetResourceUtil(context.Context, *GetResourceUtilRequest) (*GetResourceUtilResponse, error)
}
...
func (s *DRPCGigoWSUnimplementedServer) GetResourceUtil(context.Context, *GetResourceUtilRequest) (*GetResourceUtilResponse, error) {
	return nil, drpcerr.WithCode(errors.New("Unimplemented"), drpcerr.Unimplemented)
}

type DRPCGigoWSDescription struct{}

func (DRPCGigoWSDescription) NumMethods() int { return 6 }
...
func (DRPCGigoWSDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	...
	case 5:
		return "/ws.GigoWS/GetResourceUtil", drpcEncoding_File_gigo_ws_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCGigoWSServer).
					GetResourceUtil(
						ctx,
						in1.(*GetResourceUtilRequest),
					)
			}, DRPCGigoWSServer.GetResourceUtil, true
	default:
...
type DRPCGigoWS_GetResourceUtilStream interface {
	drpc.Stream
	SendAndClose(*GetResourceUtilResponse) error
}

type drpcGigoWS_GetResourceUtilStream struct {
	drpc.Stream
}

func (x *drpcGigoWS_GetResourceUtilStream) SendAndClose(m *GetResourceUtilResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_gigo_ws_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
